...
### v2.0 新功能
- ✅ **AI 学习助手** — 智能分析学习状态、薄弱点检测、个性化学习计划
- ✅ **知识图谱** — Canvas 力导向可视化，探索信号节点关联
- ✅ **键盘快捷键** — Ctrl+1-4 导航、Ctrl+N 添加、Ctrl+K 搜索、Ctrl+/ 帮助
- ✅ **全局搜索** — 快速定位单词、标签、释义，支持最近搜索
- ✅ **推送通知** — 复习提醒、成就解锁、Toast 通知系统
- ✅ **微交互动画** — 数字动画、彩纸庆祝、磁力按钮、进度环
- ✅ **里程碑庆祝** — 10/50/100/500/1000 节点自动触发成就弹窗
- ✅ **内容类型系统** — 单词/公式/知识点/错题/名词解释 分层记忆
- ✅ **碎片化复习** — 快速10张卡片，通勤/排队场景适配
- ✅ **自适应难度** — 学习时段分析、疲劳度检测、每日目标自定义
- ✅ **批量导入** — CSV/TSV 导入，预览校验，模板下载
